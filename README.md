...
## HARDWARE A1
```
updateFirmware {"version":"https://github.com/fgalian/iotclient/raw/refs/heads/main/firmware/FW-PROTOA1-MED-0.7.4.bin"}
```

## HARDWARE A2 Medidores
```
updateFirmware {"version":"https://github.com/fgalian/iotclient/raw/refs/heads/main/firmware/FW-A2-MED-0.7.4.bin"}
```
...
| **FW-Ax-MED**| [✅](firmware/FW-PROTOA1-MED-0.7.4.bin) | [✅](firmware/FW-A2-MED-0.7.4.bin) |
